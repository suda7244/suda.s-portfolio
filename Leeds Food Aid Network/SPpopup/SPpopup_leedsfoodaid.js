...
console.log("✅ popup js loaded (always show version)");
...
function cookieConsent(){
  console.log("✅ always showing popup without cookie check");
...
window.addEventListener("load", function(){
  console.log("✅ window loaded, triggering always-on popup");
  cookieConsent();
});
